# load the data
load(file="final_data/EUMDS/clinical_data.RData")
load(file="final_data/EUMDS/mutations_data.RData")
load(file="final_data/EUMDS/mutations.RData")
...
# save the results
save(clinical_data,file="input_data_testing/clinical_data.RData")
save(datasets,file="input_data_testing/datasets.RData")
save(ccf.datasets,file="input_data_testing/ccf.datasets.RData")
save(vaf.datasets,file="input_data_testing/vaf.datasets.RData")
